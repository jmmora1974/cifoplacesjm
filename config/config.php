 ...
 * @since v1.8.5 añadida la constante ROLE_MODERADOR, para configurar las autorizaziones de los lugares, fotos y comentarios
 * 
 */
...
define('LUGAR_IMAGE_FOLDER','/images/lugares');

// imagen por defecto para los lugares que no tengan
define('DEFAULT_LUGAR_IMAGE', 'default.png');
...
define('STATS_ROLES', ['ROLE_ADMIN', 'ROLE_TEST', 'ROLE_MODERADOR']);
